...
**Estado**: planificación, S01 y S02 completos; S03A tiene modelo/configuración verde y V2-T020/V2-T023 parciales. Este documento publica el task set estable `production-model-v2.0.0`, con IDs `V2-T001`–`V2-T103`. Existen solución, convenciones de persistencia y cinco entidades de catálogo; todavía no existen migraciones ni `database/setup.sql`.
